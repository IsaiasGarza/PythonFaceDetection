...
# Originally this code was forked from github user 'omab'
# http://github.com/omab/faces/tree/master/pyfaces
# but in later implementations Im going to use opencv
